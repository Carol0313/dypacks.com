-- ============================================
-- Blog Article 4: Custom Packaging with Logo
-- ============================================
-- 宝塔面板发布方式：
-- 1. 登录宝塔面板 → 数据库 → 找到您的网站数据库 → 管理（phpMyAdmin）
-- 2. 点击左侧 blog_posts 表
-- 3. 点击顶部"SQL"标签
-- 4. 把下面整段SQL粘贴进去 → 点击"执行"
--
-- ⚠️ 注意：如果 authorId=1 不存在，请先改成您管理员用户的ID
--    查询方法：SELECT id, username FROM users; （看哪个是管理员）
-- ============================================
...
INSERT INTO `blog_posts` (
  ...
  'custom-packaging-with-logo-small-business-guide',
...
Request a Free Quote → https://dypacks.com/contact',
  '/products/product-black-gold-magnetic-box.jpg',
  1,
  'published',
